...
export const products = [
  {
    ...
    description: "Elegant traditional Kanjivaram silk saree with rich zari border.",
      color: "Red",
...

  {
    ...
    description: "Premium Banarasi saree perfect for bridal and wedding wear.",
    price: 12000,
...

  {
    ...
    description: "Comfortable cotton saree ideal for daily wear.",
    price: 2200,
    image: [p_img3],
    category: "Cotton",
...

  {
    ...
    description: "Beautiful georgette saree with embroidery work.",
    price: 4800,
    image: [p_img5],
    category: "Georgette",
...

  {
    ...
    description: "Light chiffon saree with elegant prints.",
    price: 3200,
    image: [p_img6],
    category: "Chiffon",
    subCategory: "Printed",
...

  {
    ...
    description: "Grand bridal silk saree with heavy zari work.",
    price: 15000,
    image: [p_img7],
    category: "Bridal",
    subCategory: "Wedding",
...

  {
    ...
    description: "Elegant organza saree with subtle golden detailing.",
    price: 5400,
    image: [p_img8],
    category: "Organza",
